...
pub struct LinePipelineCache {
    sets: HashMap<usize, Vec<vk::DescriptorSet>>,
    pool: vk::DescriptorPool,
    pub device: Rc<ash::Device>,
}
impl LinePipelineCache {
...
impl Drop for LinePipelineCache {
    fn drop(&mut self) {
...
impl LinePipeline {
    ...
    pub fn get_cache(&mut self, frame_index: usize) -> &mut LinePipelineCache {
        while frame_index >= self.caches.len() {
            self.caches.push(LinePipelineCache::new(&self.device));
        }
