...
impl Pass {
    pub fn shadow(dev: &mut Dev) -> Self {
        ...
        let init_dep = vk::SubpassDependency::builder()
            .src_subpass(vk::SUBPASS_EXTERNAL)
            .dst_subpass(0)
            // Wait for all reads to finish in previous frame ..
            .src_stage_mask(vk::PipelineStageFlags::BOTTOM_OF_PIPE)
            .src_access_mask(vk::AccessFlags::MEMORY_READ)
            // .. before reading or writing to color attachment in color attachment output
            .dst_stage_mask(
        ...
        let last_dep = vk::SubpassDependency::builder()
            .src_subpass(0)
        ...
        let dependencies = vec![init_dep, last_dep];
    ...
    pub fn new(dev: &mut Dev) -> Self {
        ...
        let init_dependency = vk::SubpassDependency::builder()
            ...
            .src_stage_mask(vk::PipelineStageFlags::BOTTOM_OF_PIPE)
            .src_access_mask(vk::AccessFlags::MEMORY_READ)
            // .. before reading or writing to color attachment
        ...
        let output_to_input_dependency = vk::SubpassDependency::builder()
            .src_subpass(0)
            .dst_subpass(1)
            // Wait all write to color and depth to finish ..
            .src_stage_mask(vk::PipelineStageFlags::BOTTOM_OF_PIPE)
            .src_access_mask(vk::AccessFlags::MEMORY_READ)
        ...
        let present_dependency = vk::SubpassDependency::builder()
            .src_subpass(1)
            .dst_subpass(vk::SUBPASS_EXTERNAL)
            // Wait for read and write to color to finish ..
            .src_stage_mask(vk::PipelineStageFlags::COLOR_ATTACHMENT_OUTPUT)
            .src_access_mask(
                vk::AccessFlags::COLOR_ATTACHMENT_READ | vk::AccessFlags::COLOR_ATTACHMENT_WRITE,
            )
            // Before doing memory read at the end
            .dst_stage_mask(vk::PipelineStageFlags::BOTTOM_OF_PIPE)
            .dst_access_mask(vk::AccessFlags::MEMORY_READ)
            .dependency_flags(vk::DependencyFlags::BY_REGION)
            .build();
