...
impl Pass {
    pub fn new(dev: &mut Dev) -> Self {
        ...
        // Used in the light pre-pass as a depth attachment and then sampled in the light subpass to make shadows
        ...
        let shadow_input_ref = vk::AttachmentReference::builder()
            .attachment(4)
            .layout(vk::ImageLayout::SHADER_READ_ONLY_OPTIMAL)
            .build();
        ...
        // Three subpasses
        let subpasses = [
            // Light pre-subpass creates a shadow-map
        ...
        let light_dependency = vk::SubpassDependency::builder()
            .src_subpass(0)
            .dst_subpass(2)
